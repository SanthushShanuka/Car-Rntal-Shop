...
public class UserController {
    ...
    public void saveUserDetails(ActionEvent event) {
        ...
        if (alert.showAndWait().get()==ButtonType.OK) {
            if (idText.getText().isEmpty() && nameText.getText().isEmpty() && emailText.getText().isEmpty() && usernameText.getText().isEmpty() && passwordText.getText().isEmpty() && addressText.getText().isEmpty()){
