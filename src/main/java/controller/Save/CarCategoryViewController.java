...
public class CarViewController {
    ...
    CarCategoryService carCategoryService= (CarCategoryService<CarCategoryDto>) ServiceFactory.getInstance().getService(ServiceFactory.ServiceType.CATEGORY);
    ...
    public void saveCar(ActionEvent event) {
        ...
        if (alert.showAndWait().get()== ButtonType.OK) {
            if (idText.getText().isEmpty()&&priceText.getText().isEmpty()&&yearText.getText().isEmpty()&&noText.getText().isEmpty()&&
                ...
                CarCategoryDto carCategoryDto = CarCategoryService.search(categoryText.getText());
    ...
    public void showCars(ActionEvent event) {
        ...
        if (carEntity!=null){
            ...
            yearText.setText(carEntity.getYears());
